...
Print_Sucess_Info()
{
    ...
    Echo_Green "Install NMPScript completed! enjoy it."
}
...
Print_Failed_Info()
{
    ...
    Echo_Red "Please visit https://github.com/laingyulee/nmpscript/issues feedback errors and logs."
}
